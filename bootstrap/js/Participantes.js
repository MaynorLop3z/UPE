...
$("#frmADDAlumno").submit(function(event) {
    ...
    var $form = $(this), AlumnoNombre = $form.find("input[name='AlumnoNombre']").val(), UsuarioPassword = $form.find("input[name='UsuarioPassword']").val(), UsuarioEmail = $form.find("input[name='UsuarioEmail']").val(), url = $form.attr("action");
    var posting = $.post(url, {AlumnoNombre: AlumnoNombre, UsuarioPassword: UsuarioPassword, UsuarioEmail: UsuarioEmail});
