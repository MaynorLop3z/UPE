                ...
                <tr  data-dipd='<?php echo json_encode($alu) ?>' 
                     id="calif<?php echo $alu->CodigoGruposParticipantes ?>" >
                        ...
                        <td class="gestion_dip" style="width:150px;">
                            <button id="btnGuardarCalificacion<?php echo $alu->CodigoGruposParticipantes ?>" onclick="guardarC('<?php echo $alu->CodigoGruposParticipantes?>')" title="Guardar" class="btndeldip btn btn-success" class="btn btn-info btn-lg"><span class=" glyphicon glyphicon-save"></span></button>
                            <button id="btnEditarCalificacion<?php echo $alu->CodigoGruposParticipantes ?>" onclick="editarC('<?php echo $alu->CodigoGruposParticipantes?>')" disabled="disabled" title="Editar" class="btndeldip btn btn-info" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-edit"></span></button>
                        </td>
                </tr>
               <?php 
                $cont++;
