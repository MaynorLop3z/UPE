    ...
    <body>
        ...
        <div class="container">
            ...
            <div   class="container well">
                ...
                <button id="btnUsuarioNuevo" class="btn btn-default btn-default" ><span class="glyphicon glyphicon-plus"></span>Usuario Nuevo</button>
            </div>
...
//                                    $('#mensajes').append('colocar aca un alert de boostrap');
////                                   
