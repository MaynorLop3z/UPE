...
<div id="NuevoArchivoMod" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="container-fluid">
                ...
                <form id="frmDELpubGr" action="" class="form-horizontal">
                    ...
                    <div class="modal-footer">
                        <button type="button" id="btnEliminarPubGr" class="btn btn-danger btn-ok" name="Eliminar"> SI </button>
