            ...
            if ($this->input->post()) {
              ...
              if(count($Diplomados)>0){
                foreach ($Diplomados as $dip) {
                    ...
                    $registro .= '<button id="Addmod'. $dip['CodigoDiplomado'] .'"onclick="AddModDip('.$dip['CodigoDiplomado'] .')"  title="Agregar Modulos" class="btnAddMod btn btn-info" class="btn btn-info btn-lg"><span class="glyphicon glyphicon-plus"></span></button>';
